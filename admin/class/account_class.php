...
class Account {
    ...
    public function insert_account(){
        ...
        $check_query = "SELECT * FROM tbl_account_admin WHERE username = '$username' OR email = '$email'";
        ...
        if ($check_result && $check_result->num_rows > 0) {
            ...
            $insert_query = "INSERT INTO tbl_account (username, password) VALUES ('$username', '$password')";
    ...
    public function check_login($username, $password) {
        $query = "SELECT * FROM tbl_account_admin WHERE username = '$username' AND password = '$password'";
    ...
    public function update_account($email, $phone_number, $addres, $full_name, $username){
